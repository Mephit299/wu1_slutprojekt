...
let achievements = [
    {
        description: 'The begaining of the end. ',
        requiredUpgrades: 1,
        acquired: false,
    },
    {
...
function createCard(upgrade) {
    ...
    card.addEventListener('click', (e) => {
        if (money >= upgrade.cost) {
            ...
            message('Memes sacrifesed for the greater good!', 'success');
        } else {
            message('Inusficent shtposting', 'warning');
        }
    });
